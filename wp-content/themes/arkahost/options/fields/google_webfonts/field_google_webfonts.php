<?php
class king_options_google_webfonts extends king_options{	
	...
	*/
	function render(){
		...
		echo '<p class="description" style="color:red;">'.__('The fonts provided below are free to use custom fonts from the','arkahost').' <a href="http://www.'.'google.com/webfonts'.'" target="_blank">'.__('Google Web Fonts directory','arkahost').'</a>.<br/>Please <a href="http://www.'.'google.com/webfonts'.'" target="_blank">browse the directory</a>'.__(' to preview a font, then select your choice below.', 'arkahost').'</p>';
