<?php
class king_options_button_set extends king_options{	
	...
	*/
	function render(){
		...
		echo '<fieldset class="buttonset'.(isset($this->field['icon'])?' has_preview':'').'">';
		...
		echo '</fieldset>';
		if(isset($this->field['icon'])){
			echo '<img src="'. $this->field['icon'] .'" class="preview_icon"/>';
		}
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			...
			king_options_URL.'fields/button_set/field_button_set.js', 
