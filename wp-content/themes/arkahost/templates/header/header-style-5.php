...
<header class="header">
	<div class="container">
	    <!-- Logo -->
	    <div class="logo">
		    <a href="<?php echo esc_url(home_url('/')); ?>" id="logo" class="<?php echo (isset($king->cfg['compact_logo']) && !empty($king->cfg['compact_logo'])) ? 'has_compact_logo':''?>">
	    		...
	    		<?php if(isset($king->cfg['compact_logo']) && !empty($king->cfg['compact_logo'])):?>
	    			<img class="compact_logo" src="<?php echo esc_url( $king->cfg['compact_logo']); ?>" alt="<?php bloginfo('description'); ?>" />
	    		<?php endif;?>
			</a>
	    </div>
		<!-- Navigation Menu -->
