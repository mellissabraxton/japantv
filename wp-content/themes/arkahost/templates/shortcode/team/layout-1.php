...
$words = $atts['words'];
if ( $posts->have_posts() ){
	echo '<div class="feature_section14_elm">';
	while ( $posts->have_posts() ) :
		...
		$cls = 'one_half';
?>	
	<div class="<?php echo esc_attr($cls); ?> animated <?php echo esc_attr( $eff ); ?> delay-<?php echo esc_attr( $i );?>00ms<?php if( $i%2==0 )echo ' last' ?>">  
