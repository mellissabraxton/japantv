...
function king_get_whois_server(){
	...
	$servers = array(
		...
		"website" 	=> array("whois.nic.website","No match for"),
		"site" 	=> array("whois.nic.site","No match for"),
		...
		"za" 		=> array("whois.co.za","No Matches"),
		"co.za" 		=> array("whois.coza.net.za","Available"),
	);
