<?php
/*
 * Request for send points tab
 */
if (!defined('ABSPATH')) {
    exit; // Exit if accessed directly.
}
if (!class_exists('RSRequestForSendPoint')) {
    ...
    class RSRequestForSendPoint {
        ...
        public static function init() {
            ...
            add_action('woocommerce_rs_settings_tabs_rewardsystem_request_for_send_points', array(__CLASS__, 'reward_system_register_admin_settings')); // Call to register the admin settings in the Reward System Submenu with general Settings tab        

            add_action('woocommerce_update_options_rewardsystem_request_for_send_points', array(__CLASS__, 'reward_system_update_settings')); // call the woocommerce_update_options_{slugname} to update the reward system                               
        ...
        public static function reward_system_tab_setting($setting_tabs) {
            ...
            $setting_tabs['rewardsystem_request_for_send_points'] = __('Send Points Requests', 'rewardsystem');
            return $setting_tabs;
        }
        ...
        public static function reward_system_admin_fields() {
            ...
            return apply_filters('woocommerce_rewardsystem_request_for_send_point_settings', array(
                array(
                    'name' => __('Send Point Requests', 'rewardsystem'),
                    'type' => 'title',
