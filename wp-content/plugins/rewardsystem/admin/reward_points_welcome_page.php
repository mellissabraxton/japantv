        ...
        <div class="Brand_featured">
            ...
            <div class="feature">
                ...
                <div class="two_fet_img">
                    ...
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/sumo_subscription.png" alt=""/>
                        <div class="hide">
                ...
                <a href="https://codecanyon.net/item/sumo-memberships-woocommerce-membership-system/16642362?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/sumo_membership.png" alt=""/>
                        <div class="hide">
              ...
              <div class="two_fet_img">
                <a href="https://codecanyon.net/item/sumo-discounts-advanced-pricing-woocommerce-discount-system/17116628?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/sumo_discount.png" alt=""/>
                        <div class="hide">
                ...
                <a href="https://codecanyon.net/item/sumo-coupons-woocommerce-coupon-system/16082070?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/sumo_coupons.png" alt=""/>
                        <div class="hide">
                            <h4>SUMO Coupons</h4>
                        </div>
                        <div class="description">
        ...
        <div class="feature">
             <div class="two_fet_img">
                <a href="https://codecanyon.net/item/woocommerce-recover-abandoned-cart/7715167?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/Recover_abandoned_cart.png" alt=""/>
                        <div class="hide">
                ...
                <a href="https://codecanyon.net/item/sumo-affiliates-woocommerce-affiliate-system/18273930?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/sumo_affiliates.png" alt=""/>
                        <div class="hide">
             ...
             <div class="two_fet_img">
                <a href="https://codecanyon.net/item/woocommerce-pay-your-price/7000238?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/pay_your_price.png" alt=""/>
                        <div class="hide">
                ...
                <a href="https://codecanyon.net/item/galaxy-funder-woocommerce-crowdfunding-system/7360954?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/Galaxy_funder.png" alt=""/>
                        <div class="hide">
                            <h4>Galaxy Funder</h4>
                        </div>
                        <div class="description_adv">
        ...
        <div class="feature">
            <div class="two_fet_img">
               <a href="https://codecanyon.net/item/universe-funder-woocommerce-crowdfunding-system/10283380?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/Universe_Funder.png" alt=""/>
                        <div class="hide">
               ...
               <a href="https://codecanyon.net/item/woocommerce-paypal-adaptive-split-payment/7948397?ref=FantasticPlugins" target="_blank" >
                    <div class="Brand_1">
                        <img src="<?php echo REWARDSYSTEM_PLUGIN_DIR_URL;?>/admin/images/paypal_adaptive_split_payment.png" alt=""/>
                        <div class="hide">
